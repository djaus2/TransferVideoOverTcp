...
public partial class MainWindow : Window
{
    ...
    private void ShowAboutDialog()
    {
        ...
        {
            Title = "About Video Download Manager",
            Width = 500,
            Height = 400,
        ...
        {
            Text = "A WPF application for managing the GetVideoService Windows Service.",
            FontSize = 14,
        ...
        {
            Text = "• Install/Uninstall Windows Service\n" +
                   "• Start/Stop Service Control\n" +
                   "• Manual Video Download Listening\n" +
                   "• Download File Management\n" +
                   "• Real-time File Monitoring\n" +
                   "• Busy Indicators for Operations",
            FontSize = 12,
